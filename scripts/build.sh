...
electron-packager . "${APP_NAME}" --platform=$PLATFORM --arch=$ARCH --electronVersion=3.0.8 --app-version=2.2.1 --asar --icon=assets/icon.icns --overwrite --out=./dist --ignore=${ignore_list}
