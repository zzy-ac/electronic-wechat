...
electron-packager . "${APP_NAME}" --platform=$PLATFORM --arch=$ARCH --electronVersion=3.0.6 --app-version=2.2.0 --asar --icon=assets/icon.icns --overwrite --out=./dist --ignore=${ignore_list}
