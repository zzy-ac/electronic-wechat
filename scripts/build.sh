...
electron-packager . "${APP_NAME}" --platform=$PLATFORM --arch=$ARCH --electronVersion=2.0.0 --app-version=2.1.5 --asar --icon=assets/icon.icns --overwrite --out=./dist --ignore=${ignore_list}
